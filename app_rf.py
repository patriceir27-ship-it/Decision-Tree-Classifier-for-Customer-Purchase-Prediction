...
st.set_page_config(page_title="Bank Marketing — Random Forest", layout="wide")

st.title("🌲 Bank Marketing — Random Forest Deployment (Fast)")
st.write("This app uses **PCA features** (PC1..PCk) exactly as trained.")

MODEL_PATH = "bank_marketing_rf_fast.pkl"
